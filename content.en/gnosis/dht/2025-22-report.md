...
# Gnosis discv5 weekly report 2025-22
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/agent_types_avg_1d_plot.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/agent_types_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/agent_semvers_avg_1d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/agent_semvers_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/protocols_support_over_7d_plot.json" height="1200px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/quic_support_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/countries_avg_1d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/countries_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/is_cloud_avg_1d_plot.json" height="400px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/is_cloud_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/cloud_provider_avg_1d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/cloud_provider_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/fork_digest_over_7d_plot.json" height="600px" >}}

### Next Forks

The following graph shows the advertised next forks that the nodes intend to follow at a certain future epoch.

{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/next_fork_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/gnosis_mainnet/2025/06/01/stale_records_7d_plot.json" height="600px" >}}
...
- **Number of visits: `148248`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique addresses discovered in the DHT: `3198`**
