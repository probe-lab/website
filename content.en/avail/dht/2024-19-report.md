...
- Number of visits `5,780,142`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `23,819`
- Number of unique peer IDs discovered in the DHT `20,658`
- Number of unique IP addresses found `10,328`
...
{{< plotly json="../../../plots/2024/05/06/avail-plot-churn.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/05/06/avail-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="../../../plots/2024/05/06/avail-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/05/06/avail-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/05/06/avail-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/05/06/avail-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/05/06/avail-crawl-protocols.json" height="1200px" >}}

#### Errors

{{< plotly json="../../../plots/2024/05/06/avail-connection-errors-single.json" height="600px" >}}

{{< plotly json="../../../plots/2024/05/06/avail-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/05/06/avail-stale-records-stacked.json" height="600px" >}}
