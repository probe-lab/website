...
{{< plotly json="/plots/avail-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/avail-agents-versions.json" height="600px" >}}
...
{{< plotly json="/plots/avail-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/avail-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/avail-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/avail-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/avail-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/avail-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/avail-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots/avail-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/avail-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/avail-regions-population.json" height="600px" >}}
...
{{< plotly json="/plots/avail-density-distributions.json" height="600px" >}}
...
{{< plotly json="/plots/avail-stale-records-stacked.json" height="600px" >}}