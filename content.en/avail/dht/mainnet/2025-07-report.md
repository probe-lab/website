...
- **Number of visits: `673,473`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `5,597`**
...
- **Number of unique IP addresses discovered: `3,179`**
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-agents-versions.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-regions-population.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-density-distributions.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/10/avail-stale-records-stacked.json" height="600px" >}}