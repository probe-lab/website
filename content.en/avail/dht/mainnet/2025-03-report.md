...
- **Number of visits: `668,488`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `5,406`**
...
- **Number of unique IP addresses discovered: `2,988`**
...
{{< plotly json="/plots/2025/01/13/avail-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/2025/01/13/avail-agents-versions.json" height="600px" >}}
...
{{< plotly json="/plots/2025/01/13/avail-regions-population.json" height="600px" >}}
...
{{< plotly json="/plots/2025/01/13/avail-density-distributions.json" height="600px" >}}
