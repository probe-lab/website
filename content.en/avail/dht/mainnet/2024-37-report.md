...
- Number of visits `2,913,077`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `6,707`
- Number of unique peer IDs discovered in the DHT `6,707`
- Number of unique IP addresses found `3,302`
...
{{< plotly json="/plots/2024/09/09/avail-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/2024/09/09/avail-agents-versions.json" height="600px" >}}
...
{{< plotly json="/plots/2024/09/09/avail-plot-churn.json" height="600px" >}}
...
{{< plotly json="/plots/2024/09/09/avail-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2024/09/09/avail-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2024/09/09/avail-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2024/09/09/avail-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2024/09/09/avail-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2024/09/09/avail-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots/2024/09/09/avail-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/2024/09/09/avail-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/2024/09/09/avail-stale-records-stacked.json" height="600px" >}}
