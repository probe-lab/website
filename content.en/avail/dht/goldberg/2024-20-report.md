...
- Number of visits `5,683,767`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `23,046`
- Number of unique peer IDs discovered in the DHT `19,862`
- Number of unique IP addresses found `9,914`
...
{{< plotly json="/plots/2024/05/13/avail-plot-churn.json" height="600px" >}}
...
{{< plotly json="/plots/2024/05/13/avail-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2024/05/13/avail-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2024/05/13/avail-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2024/05/13/avail-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2024/05/13/avail-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2024/05/13/avail-crawl-protocols.json" height="1200px" >}}

#### Errors

{{< plotly json="/plots/2024/05/13/avail-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/2024/05/13/avail-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/2024/05/13/avail-stale-records-stacked.json" height="600px" >}}
