...
{{< plotly json="/plots/avail_lc-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/avail_lc-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/avail_lc-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/avail_lc-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/avail_lc-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/avail_lc-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/avail_lc-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/avail_lc-crawl-protocols.json" height="1200px" >}}
...
{{< plotly json="/plots/avail_lc-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/avail_lc-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/avail_lc-stale-records-stacked.json" height="600px" >}}