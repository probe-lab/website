...
{{< plotly json="/plots//celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-client-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-client-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots//celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots//celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots//celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots//celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots//celestia-stale-records-stacked.json" height="600px" >}}