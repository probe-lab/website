...
# Celestia Report Cal. Week 30 - 2025
...
- **Number of unique IP addresses discovered: `164`**
...
{{< plotly json="/plots/2025/07/21/celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-client-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-client-versions-distribution.json" height="600px" >}}

The choropleth plot below shows the agent version by geographical location, sourced from IP addresses.

{{< plotly json="https://cdn.probelab.io/ants_plots/celestia_mainnet/2025/7/21/requests_aggregation_geolocation_plot.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2025/07/21/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots/2025/07/21/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/2025/07/21/celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/2025/07/21/celestia-stale-records-stacked.json" height="600px" >}}