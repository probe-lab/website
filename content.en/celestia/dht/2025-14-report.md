...
# Celestia Report Cal. Week 14 - 2025

## General Information

The following results show measurement data that were collected in calendar week 14 in 2025 from `2025-03-31` to `2025-04-07`.

- **Number of crawls: `84`**
  
  The number of crawls executed during the week indicated above.

- **Number of visits: `74,452`**
...
- **Number of unique IP addresses discovered: `159`**
...
{{< plotly json="/plots/2025/03/31/celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-client-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-client-versions-distribution.json" height="600px" >}}

The choropleth plot below shows the agent version by geographical location, sourced from IP addresses.

{{< plotly json="https://cdn.probelab.io/ants_plots/celestia_mainnet/2025/3/31/requests_aggregation_geolocation_plot.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2025/03/31/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots/2025/03/31/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/2025/03/31/celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/31/celestia-stale-records-stacked.json" height="600px" >}}
