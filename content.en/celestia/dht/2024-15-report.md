...
{{< plotly json="../../../plots/2024/04/08/celestia-plot-churn.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/04/08/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="../../../plots/2024/04/08/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/04/08/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/04/08/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/04/08/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/04/08/celestia-crawl-protocols.json" height="1200px" >}}

#### Errors

{{< plotly json="../../../plots/2024/04/08/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="../../../plots/2024/04/08/celestia-crawl-errors-single.json" height="600px" >}}
...
This plot displays data about all nodes participating in `celestia` and isn't limited to Celestia mainnet nodes.

{{< plotly json="../../../plots/2024/04/08/celestia-stale-records-stacked.json" height="600px" >}}