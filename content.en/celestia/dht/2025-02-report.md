...
# Celestia Report Cal. Week 2 - 2025

## General Information

The following results show measurement data that were collected in calendar week 2 in 2025 from `2025-01-06` to `2025-01-13`.

- **Number of crawls: `84`**
  
  The number of crawls executed during the week indicated above.

- **Number of visits: `60,032`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `252`**
...
- **Number of unique IP addresses discovered: `204`**
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-versions-distribution.json" height="600px" >}}

## Lightnode Population

> ⚠️ Our [DHT Client monitoring tool](https://github.com/probe-lab/ants-watch) did not support Secure WebSocket (`wss`) up to 2025-01-09, hence the jump in numbers of nodes afterwards, as well as the appearance of `lumina` nodes from that date onwards.
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-client-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-client-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/06/celestia-stale-records-stacked.json" height="600px" >}}
