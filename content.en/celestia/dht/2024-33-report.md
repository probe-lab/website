...
# Celestia Report Cal. Week 33 - 2024
...
- Number of visits `279,868`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `553`
- Number of unique peer IDs discovered in the DHT `553`
- Number of unique IP addresses found `647`
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-plot-churn.json" height="800px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/12/celestia-stale-records-stacked.json" height="600px" >}}