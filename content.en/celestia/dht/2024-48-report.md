...
# Celestia Report Cal. Week 48 - 2024
...
- **Number of crawls: `143`**
  
  The number of crawls executed during the week indicated above.

- **Number of visits: `115,548`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `276`**
...
- **Number of unique IP addresses discovered: `273`**
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-versions-distribution.json" height="600px" >}}
...
<!---->
<!--{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-client-agents-overall-stacked.json" height="600px" >}}-->
<!---->
...
<!---->
<!--{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-client-versions-distribution.json" height="600px" >}}-->
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/celestia-stale-records-stacked.json" height="600px" >}}