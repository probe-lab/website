...
# Celestia Report Cal. Week 19 - 2025

## General Information

The following results show measurement data that were collected in calendar week 19 in 2025 from `2025-05-05` to `2025-05-12`.

- **Number of crawls: `84`**
  
  The number of crawls executed during the week indicated above.

- **Number of visits: `76,874`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `165`**
...
- **Number of unique IP addresses discovered: `147`**
...
{{< plotly json="/plots/2025/05/05/celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-client-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-client-versions-distribution.json" height="600px" >}}

The choropleth plot below shows the agent version by geographical location, sourced from IP addresses.

{{< plotly json="https://cdn.probelab.io/ants_plots/celestia_mainnet/2025/5/05/requests_aggregation_geolocation_plot.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2025/05/05/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots/2025/05/05/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/2025/05/05/celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/05/celestia-stale-records-stacked.json" height="600px" >}}