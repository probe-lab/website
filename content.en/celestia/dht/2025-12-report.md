...
# Celestia Report Cal. Week 12 - 2025

## General Information

The following results show measurement data that were collected in calendar week 12 in 2025 from `2025-03-17` to `2025-03-24`.

- **Number of crawls: `84`**
  
  The number of crawls executed during the week indicated above.

- **Number of visits: `73,651`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `166`**
...
- **Number of unique IP addresses discovered: `181`**
...
{{< plotly json="/plots/2025/03/17/celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-client-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-client-versions-distribution.json" height="600px" >}}

The choropleth plot below shows the agent version by geographical location, sourced from IP addresses.

{{< plotly json="https://cdn.probelab.io/ants_plots/celestia_mainnet/2025/3/17/requests_aggregation_geolocation_plot.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2025/03/17/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots/2025/03/17/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/2025/03/17/celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/17/celestia-stale-records-stacked.json" height="600px" >}}