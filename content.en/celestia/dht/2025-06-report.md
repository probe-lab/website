...
# Celestia Report Cal. Week 6 - 2025
...
- **Number of visits: `58,317`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `193`**
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-client-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-client-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/03/celestia-stale-records-stacked.json" height="600px" >}}