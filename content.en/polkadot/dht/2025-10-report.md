...
# Polkadot Report Cal. Week 10 - 2025
...
- **Number of visits: `2,896,069`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `10,370`**
...
- **Number of unique IP addresses discovered: `12,910`**
...
{{< plotly json="/plots/2025/03/03/polkadot-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="/plots/2025/03/03/polkadot-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-agents-versions.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-plot-churn.json" height="1000px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2025/03/03/polkadot-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots/2025/03/03/polkadot-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/2025/03/03/polkadot-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/polkadot-stale-records-stacked.json" height="600px" >}}