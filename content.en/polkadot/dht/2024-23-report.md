...
# Polkadot Report Cal. Week 23 - 2024
...
- Number of visits `7,693,028`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `11,027`
- Number of unique peer IDs discovered in the DHT `10,655`
- Number of unique IP addresses found `16,947`
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-plot-churn.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-crawl-protocols.json" height="1200px" >}}

#### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/06/03/polkadot-stale-records-stacked.json" height="600px" >}}