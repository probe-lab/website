...
# Polkadot Report Cal. Week 8 - 2024

## General Information

The following results show measurement data that were collected in calendar week 8 in 2024 from `2024-02-19` to `2024-02-26`.

- Number of crawls `299`
- Number of visits `5,496,198`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `11,122`
- Number of unique peer IDs discovered in the DHT `11,077`
- Number of unique IP addresses found `13,289`
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-agents-versions.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-plot-churn.json" height="1000px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/02/19/polkadot-stale-records-stacked.json" height="600px" >}}