...
# Polkadot Report Cal. Week 38 - 2024
...
- Number of visits `6,803,252`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `12,371`
- Number of unique peer IDs discovered in the DHT `11,858`
- Number of unique IP addresses found `15,372`
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-agents-versions.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-plot-churn.json" height="1000px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-crawl-errors-single.json" height="600px" >}}
...
Please note that starting with this report, the methodology used for counting stale node records has been updated. All reports prior to this week used to count the number of `crawl_error`s from Nebula. Going forward, all reports will count the number of `connect_error`s from Nebula, better reflecting the reachability of nodes.

{{< /hint >}}

{{< plotly json="https://cdn.probelab.io/legacy/2024/09/16/polkadot-stale-records-stacked.json" height="600px" >}}
