...
{{< plotly json="/plots/polkadot-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="/plots/polkadot-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/polkadot-agents-versions.json" height="600px" >}}
...
{{< plotly json="/plots/polkadot-versions-distribution.json" height="600px" >}}
...
{{< plotly json="/plots/polkadot-plot-churn.json" height="1000px" >}}
...
{{< plotly json="/plots/polkadot-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/polkadot-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/polkadot-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/polkadot-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/polkadot-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/polkadot-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="/plots/polkadot-connection-errors-single.json" height="600px" >}}

{{< plotly json="/plots/polkadot-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="/plots/polkadot-stale-records-stacked.json" height="600px" >}}