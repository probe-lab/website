...
# Polkadot Report Cal. Week 34 - 2024
...
- Number of visits `7,528,946`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `12,900`
- Number of unique peer IDs discovered in the DHT `12,424`
- Number of unique IP addresses found `17,121`
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-agents-versions.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-plot-churn.json" height="1000px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/08/19/polkadot-stale-records-stacked.json" height="600px" >}}