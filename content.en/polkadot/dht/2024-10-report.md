...
{{< plotly json="../../../plots/2024/03/04/polkadot-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="../../../plots/2024/03/04/polkadot-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-agents-versions.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-versions-distribution.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-plot-churn.json" height="1000px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="../../../plots/2024/03/04/polkadot-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="../../../plots/2024/03/04/polkadot-connection-errors-single.json" height="600px" >}}

{{< plotly json="../../../plots/2024/03/04/polkadot-crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/03/04/polkadot-stale-records-stacked.json" height="600px" >}}