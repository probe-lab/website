...
# Polkadot Report Cal. Week 33 - 2025

## General Information

The following results show measurement data that were collected in calendar week 33 in 2025 from `2025-08-11` to `2025-08-18`.
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/agent_types_avg_1d_plot.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/agent_types_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/agent_semvers_avg_1d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/agent_semvers_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/sessions_churn_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/countries_avg_1d_plot.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/countries_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/is_cloud_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/cloud_provider_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/cloud_provider_avg_1d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/protocols_support_over_7d_plot.json" height="1200px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/dial_errors_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/crawl_errors_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/08/17/stale_records_7d_plot.json" height="600px" >}}
...
- **Number of visits: `963589`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `15853`**
...
- **Number of unique addresses discovered in the DHT: `2060`**
