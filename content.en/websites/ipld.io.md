...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-ipldio}

{{< plotly json="../../plots/latest/website-trend-metrics-ipld.io.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-ipldio}

{{< plotly json="../../plots/latest/website-trend-providers-ipld.io.json" height="350px" >}}
...
{{< plotly json="../../plots/latest/website-trend-retrieval-errors-ipld.io-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-ipldio}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-ipld.io.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-ipldio-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-ipld.io-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-ipldio-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-ipld.io-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-ipldio-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-ipld.io-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-ipldio-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-ipld.io-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-ipldio-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-ipld.io-ttfb.json" height="500px" >}}
