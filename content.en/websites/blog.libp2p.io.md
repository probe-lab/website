---
title: blog.libp2p.io
plotly: true
---

# `blog.libp2p.io`

This page shows performance metrics for the website [blog.libp2p.io](https://blog.libp2p.io). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
### Performance over Kubo {#website-snapshot-performance-gauge-bloglibp2pio-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-blog.libp2p.io-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-bloglibp2pio}

{{< plotly json="../../plots/latest/website-trend-metrics-blog.libp2p.io.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-bloglibp2pio}

{{< plotly json="../../plots/latest/website-trend-providers-blog.libp2p.io.json" height="350px" >}}
...
#### Known Stable Providers {#website-trend-hosters-bloglibp2pio}

{{< plotly json="../../plots/latest/website-trend-hosters-blog.libp2p.io.json" height="250px" >}}
...
### IPFS Retrieval Errors {#website-trend-retrieval-errors-bloglibp2pio-kubo}

{{< plotly json="../../plots/latest/website-trend-retrieval-errors-blog.libp2p.io-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-bloglibp2pio}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-blog.libp2p.io.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-bloglibp2pio-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-blog.libp2p.io-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-bloglibp2pio-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-blog.libp2p.io-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-bloglibp2pio-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-blog.libp2p.io-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-bloglibp2pio-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-blog.libp2p.io-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-bloglibp2pio-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-blog.libp2p.io-ttfb.json" height="500px" >}}
