...
This page shows performance metrics for the website [strn.network](https://strn.network). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
### Performance over Kubo {#website-snapshot-performance-gauge-strnnetwork-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-strn.network-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-strnnetwork}

{{< plotly json="../../plots/latest/website-trend-metrics-strn.network.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-strnnetwork}

{{< plotly json="../../plots/latest/website-trend-providers-strn.network.json" height="350px" >}}
...
#### Known Stable Providers {#website-trend-hosters-strnnetwork}

{{< plotly json="../../plots/latest/website-trend-hosters-strn.network.json" height="250px" >}}
...
### IPFS Retrieval Errors {#website-trend-retrieval-errors-strnnetwork-kubo}

{{< plotly json="../../plots/latest/website-trend-retrieval-errors-strn.network-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-strnnetwork}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-strn.network.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-strnnetwork-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-strn.network-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-strnnetwork-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-strn.network-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-strnnetwork-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-strn.network-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-strnnetwork-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-strn.network-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-strnnetwork-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-strn.network-ttfb.json" height="500px" >}}
