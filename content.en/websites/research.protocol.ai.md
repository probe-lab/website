---
title: research.protocol.ai
plotly: true
---

# `research.protocol.ai`

This page shows performance metrics for the website [research.protocol.ai](https://research.protocol.ai). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
### Performance over Kubo {#website-snapshot-performance-gauge-researchprotocolai-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-research.protocol.ai-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-researchprotocolai}

{{< plotly json="../../plots/latest/website-trend-metrics-research.protocol.ai.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-researchprotocolai}

{{< plotly json="../../plots/latest/website-trend-providers-research.protocol.ai.json" height="350px" >}}
...
#### Known Stable Providers {#website-trend-hosters-researchprotocolai}

{{< plotly json="../../plots/latest/website-trend-hosters-research.protocol.ai.json" height="250px" >}}
...
### IPFS Retrieval Errors {#website-trend-retrieval-errors-researchprotocolai-kubo}

{{< plotly json="../../plots/latest/website-trend-retrieval-errors-research.protocol.ai-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-researchprotocolai}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-research.protocol.ai.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-researchprotocolai-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-research.protocol.ai-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-researchprotocolai-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-research.protocol.ai-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-researchprotocolai-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-research.protocol.ai-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-researchprotocolai-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-research.protocol.ai-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-researchprotocolai-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-research.protocol.ai-ttfb.json" height="500px" >}}
