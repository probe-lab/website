...
This page shows performance metrics for the website [filecoin.io](https://filecoin.io).

## Overall Performance {#website-performance-gauge-filecoinio-kubo}

{{< plotly json="../../plots/latest/website-performance-gauge-filecoin.io-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-metrics-filecoinio}

{{< plotly json="../../plots/latest/website-metrics-filecoin.io.json" height="300px" >}}
