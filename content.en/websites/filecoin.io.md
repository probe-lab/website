...
This page shows performance metrics for the website [filecoin.io](https://filecoin.io). We gathered the data with our [Tiros](/tools/tiros) measurement tool.

## Overview

### General Performance {#website-snapshot-performance-gauge-filecoinio-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-filecoin.io-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-filecoinio}

{{< plotly json="../../plots/latest/website-trend-metrics-filecoin.io.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-filecoinio}

{{< plotly json="../../plots/latest/website-trend-providers-filecoin.io.json" height="350px" >}}
...
### IPFS Retrieval Errors {#website-trend-retrieval-errors-filecoinio-kubo}

{{< plotly json="../../plots/latest/website-trend-retrieval-errors-filecoin.io-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-filecoinio}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-filecoin.io.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-filecoinio-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-filecoin.io-KUBO-eu-central-1.json" height="400px" >}}
...
### Website Probing Success rate from different Regions {#website-snapshot-retrieval-errors-filecoinio}

{{< plotly json="../../plots/latest/website-snapshot-retrieval-errors-filecoin.io.json" height="350px" >}}

While the above graph on [IPFS Retrieval Errors](#website-trend-retrieval-errors-filecoinio-kubo) shows the Kubo retrieval errors over time. This graph shows the retrieval errors as seen from different regions in the specified time interval (bottom right corner). Alongside the Kubo retrieval outcomes it also shows the HTTP results. The black markers again show the number of probes performed in each region with each request method.
...
#### Time To First Byte {#website-snapshot-metric-cdf-filecoinio-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-filecoin.io-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-filecoinio-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-filecoin.io-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-filecoinio-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-filecoin.io-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-filecoinio-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-filecoin.io-ttfb.json" height="500px" >}}
