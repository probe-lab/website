---
title: specs.ipfs.tech
plotly: true
---

# `specs.ipfs.tech`

This page shows performance metrics for the website [specs.ipfs.tech](https://specs.ipfs.tech). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
### Performance over Kubo {#website-snapshot-performance-gauge-specsipfstech-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-specs.ipfs.tech-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-specsipfstech}

{{< plotly json="../../plots/latest/website-trend-metrics-specs.ipfs.tech.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-specsipfstech}

{{< plotly json="../../plots/latest/website-trend-providers-specs.ipfs.tech.json" height="350px" >}}
...
#### Known Stable Providers {#website-trend-hosters-specsipfstech}

{{< plotly json="../../plots/latest/website-trend-hosters-specs.ipfs.tech.json" height="250px" >}}
...
### IPFS Retrieval Errors {#website-trend-retrieval-errors-specsipfstech-kubo}

{{< plotly json="../../plots/latest/website-trend-retrieval-errors-specs.ipfs.tech-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-specsipfstech}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-specs.ipfs.tech.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-specsipfstech-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-specs.ipfs.tech-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-specsipfstech-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-specs.ipfs.tech-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-specsipfstech-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-specs.ipfs.tech-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-specsipfstech-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-specs.ipfs.tech-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-specsipfstech-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-specs.ipfs.tech-ttfb.json" height="500px" >}}
