...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-greenfilecoinio}

{{< plotly json="../../plots/latest/website-trend-metrics-green.filecoin.io.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-greenfilecoinio}

{{< plotly json="../../plots/latest/website-trend-providers-green.filecoin.io.json" height="350px" >}}
...
{{< plotly json="../../plots/latest/website-trend-retrieval-errors-green.filecoin.io-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-greenfilecoinio}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-green.filecoin.io.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-greenfilecoinio-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-green.filecoin.io-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-greenfilecoinio-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-green.filecoin.io-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-greenfilecoinio-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-green.filecoin.io-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-greenfilecoinio-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-green.filecoin.io-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-greenfilecoinio-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-green.filecoin.io-ttfb.json" height="500px" >}}
