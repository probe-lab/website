---
title: tldr.filecoin.io
plotly: true
---

# `tldr.filecoin.io`

This page shows performance metrics for the website [tldr.filecoin.io](https://tldr.filecoin.io). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
### Performance over Kubo {#website-snapshot-performance-gauge-tldrfilecoinio-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-tldr.filecoin.io-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-tldrfilecoinio}

{{< plotly json="../../plots/latest/website-trend-metrics-tldr.filecoin.io.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-tldrfilecoinio}

{{< plotly json="../../plots/latest/website-trend-providers-tldr.filecoin.io.json" height="350px" >}}
...
#### Known Stable Providers {#website-trend-hosters-tldrfilecoinio}

{{< plotly json="../../plots/latest/website-trend-hosters-tldr.filecoin.io.json" height="250px" >}}
...
### IPFS Retrieval Errors {#website-trend-retrieval-errors-tldrfilecoinio-kubo}

{{< plotly json="../../plots/latest/website-trend-retrieval-errors-tldr.filecoin.io-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-tldrfilecoinio}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-tldr.filecoin.io.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-tldrfilecoinio-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-tldr.filecoin.io-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-tldrfilecoinio-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-tldr.filecoin.io-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-tldrfilecoinio-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-tldr.filecoin.io-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-tldrfilecoinio-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-tldr.filecoin.io-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-tldrfilecoinio-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-tldr.filecoin.io-ttfb.json" height="500px" >}}
