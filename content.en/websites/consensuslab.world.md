---
title: consensuslab.world
plotly: true
---

# `consensuslab.world`

This page shows performance metrics for the website [consensuslab.world](https://consensuslab.world). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
### Performance over Kubo {#website-snapshot-performance-gauge-consensuslabworld-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-consensuslab.world-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-consensuslabworld}

{{< plotly json="../../plots/latest/website-trend-metrics-consensuslab.world.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-consensuslabworld}

{{< plotly json="../../plots/latest/website-trend-providers-consensuslab.world.json" height="350px" >}}
...
#### Known Stable Providers {#website-trend-hosters-consensuslabworld}

{{< plotly json="../../plots/latest/website-trend-hosters-consensuslab.world.json" height="250px" >}}
...
### IPFS Retrieval Errors {#website-trend-retrieval-errors-consensuslabworld-kubo}

{{< plotly json="../../plots/latest/website-trend-retrieval-errors-consensuslab.world-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-consensuslabworld}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-consensuslab.world.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-consensuslabworld-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-consensuslab.world-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-consensuslabworld-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-consensuslab.world-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-consensuslabworld-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-consensuslab.world-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-consensuslabworld-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-consensuslab.world-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-consensuslabworld-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-consensuslab.world-ttfb.json" height="500px" >}}
