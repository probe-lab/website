...
### Performance over Kubo {#website-snapshot-performance-gauge-protocolai-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-protocol.ai-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-protocolai}

{{< plotly json="../../plots/latest/website-trend-metrics-protocol.ai.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-protocolai}

{{< plotly json="../../plots/latest/website-trend-providers-protocol.ai.json" height="350px" >}}
...
#### Known Stable Providers {#website-trend-hosters-protocolai}

{{< plotly json="../../plots/latest/website-trend-hosters-protocol.ai.json" height="250px" >}}
...
### Website Probes {#website-snapshot-probes-count-protocolai}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-protocol.ai.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-protocolai-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-protocol.ai-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-protocolai-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-protocol.ai-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-protocolai-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-protocol.ai-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-protocolai-kubo-lcp}
