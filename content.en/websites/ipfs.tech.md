...
This page shows performance metrics for the website [ipfs.tech](https://ipfs.tech). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
### Performance over Kubo {#website-snapshot-performance-gauge-ipfstech-kubo}

{{< plotly json="../../plots/latest/website-snapshot-performance-gauge-ipfs.tech-KUBO.json" height="300px" >}}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-ipfstech}

{{< plotly json="../../plots/latest/website-trend-metrics-ipfs.tech.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-ipfstech}

{{< plotly json="../../plots/latest/website-trend-providers-ipfs.tech.json" height="350px" >}}
...
#### Known Stable Providers {#website-trend-hosters-ipfstech}

{{< plotly json="../../plots/latest/website-trend-hosters-ipfs.tech.json" height="250px" >}}
...
### IPFS Retrieval Errors {#website-trend-retrieval-errors-ipfstech-kubo}

{{< plotly json="../../plots/latest/website-trend-retrieval-errors-ipfs.tech-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-ipfstech}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-ipfs.tech.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-ipfstech-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-ipfs.tech-KUBO-eu-central-1.json" height="400px" >}}
...
#### Time To First Byte {#website-snapshot-metric-cdf-ipfstech-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-ipfs.tech-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-ipfstech-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-ipfs.tech-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-ipfstech-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-ipfs.tech-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-ipfstech-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-ipfs.tech-ttfb.json" height="500px" >}}
