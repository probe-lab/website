...
This page shows performance metrics for the website [drand.love](https://drand.love). We gathered the data with our [Tiros](/tools/tiros) measurement tool.

## Overview

### General Performance {#website-snapshot-performance-gauge-drandlove-kubo}
...
### Web-Vitals Metrics (90th Percentile) {#website-trend-metrics-drandlove}

{{< plotly json="../../plots/latest/website-trend-metrics-drand.love.json" height="300px" >}}
...
### Unique IPFS Website Providers per Day {#website-trend-providers-drandlove}

{{< plotly json="../../plots/latest/website-trend-providers-drand.love.json" height="350px" >}}
...
{{< plotly json="../../plots/latest/website-trend-retrieval-errors-drand.love-KUBO.json" height="350px" >}}
...
### Website Probes {#website-snapshot-probes-count-drandlove}

{{< plotly json="../../plots/latest/website-snapshot-probes-count-drand.love.json" height="150px" >}}
...
### Web-Vitals Metrics measured from Europe using Kubo {#website-snapshot-web-vitals-barchart-drandlove-kubo-eu-central-1}

{{< plotly json="../../plots/latest/website-snapshot-web-vitals-barchart-drand.love-KUBO-eu-central-1.json" height="400px" >}}
...
### Website Probing Success rate from different Regions {#website-snapshot-retrieval-errors-drandlove}

{{< plotly json="../../plots/latest/website-snapshot-retrieval-errors-drand.love.json" height="350px" >}}

While the above graph on [IPFS Retrieval Errors](#website-trend-retrieval-errors-drandlove-kubo) shows the Kubo retrieval errors over time. This graph shows the retrieval errors as seen from different regions in the specified time interval (bottom right corner). Alongside the Kubo retrieval outcomes it also shows the HTTP results. The black markers again show the number of probes performed in each region with each request method.
...
#### Time To First Byte {#website-snapshot-metric-cdf-drandlove-kubo-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-drand.love-KUBO-ttfb.json" height="320px" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-drandlove-kubo-fcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-drand.love-KUBO-fcp.json" height="320px" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-drandlove-kubo-lcp}

{{< plotly json="../../plots/latest/website-snapshot-metric-cdf-drand.love-KUBO-lcp.json" height="320px" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-drandlove-ttfb}

{{< plotly json="../../plots/latest/website-snapshot-http-ratio-drand.love-ttfb.json" height="500px" >}}
