---
title: Week 2025-24 day 04
plotly: true
slug: 2025-24-04
weight: 1045581
---

# Filecoin report for message duplicates 2025-24 day 04

The following results show measurement data that were collected in **calendar week** 24  day 04 **of** 
2025 (`2025-06-12`).
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/6/12/duplicates_per_topic_ts_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/6/12/duplicates_cdf_per_msg_id_plot.json" height="600px" >}}

## Size of messages per topic

The following chart shows the CDF distribution of the message size seen by our tooling. 

{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/6/12/duplicates_cdf_of_msg_size_per_topic_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/6/12/duplicates_cdf_of_time_to_first_duplicate_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/6/12/duplicates_correlation_between_size_and_duplicates_plot.json" height="600px" >}}