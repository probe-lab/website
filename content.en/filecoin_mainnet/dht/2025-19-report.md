...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/11/keyspace_regions_population_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/11/keyspace_density_distribution_plot.json" height="600px" >}}
...
- **Number of unique peer IDs discovered in the DHT: `1612`**
...
- **Number of unique addresses discovered in the DHT: `393`**
