...
# Filecoin Report Cal. Week 18 - 2025
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/agent_types_avg_1d_plot.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/agent_types_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/agent_semvers_avg_1d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/agent_semvers_over_7d_plot.json" height="600px" >}}

This plot shows the distribution of agent versions by quality adjust power (QAP) and raw bytes power (RBP).

{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/powers_by_agent_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/protocols_support_over_7d_plot.json" height="1200px" >}}

## Quic support

This stacked chart illustrates `quic` support for Filecoin peers over time, broken down by user agent.

{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/quic_support_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/countries_avg_1d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/countries_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/is_cloud_avg_1d_plot.json" height="400px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/is_cloud_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/cloud_provider_avg_1d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/cloud_provider_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/sessions_churn_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/dial_errors_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/crawl_errors_over_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/stale_records_7d_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/keyspace_regions_population_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/04/keyspace_density_distribution_plot.json" height="600px" >}}
...
- **Number of visits: `84900`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `1667`**
...
- **Number of unique addresses discovered in the DHT: `415`**
