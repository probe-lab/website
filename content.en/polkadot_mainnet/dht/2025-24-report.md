...
# Polkadot Report Cal. Week 24 - 2025
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/agents-versions.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/plot-churn.json" height="1000px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/crawl-protocols.json" height="1200px" >}}

### Errors

{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/connection-errors-single.json" height="600px" >}}

{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/crawl-errors-single.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/plots/polkadot_mainnet/2025/06/15/stale-records-stacked.json" height="600px" >}}
...
- **Number of visits: `634857`**

  Every attempt to dial or connect to a peer counts as a visit. Regardless of errors that may occur. We visit peers many times during a given week to extract information from them or probe for their uptime. We visit all peers that we discover in the DHT and peers that we found to be still online from the previous week.

- **Number of unique peer IDs discovered in the DHT: `9957`**
...
- **Number of unique addresses discovered in the DHT: `1671`**
