...
# Ethereum report for GossipSub's Control Messages 2025-43 day 03
...
{{< plotly json="https://cdn.probelab.io/control_rpcs_reports/ethereum_mainnet/2025/10/22/control_rpc_ratio_ts_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/control_rpcs_reports/ethereum_mainnet/2025/10/22/control_rpc_effectiveness_msg_id_ts_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/control_rpcs_reports/ethereum_mainnet/2025/10/22/control_rpc_effectiveness_msg_id_per_topic_ts_plot.json" height="600px" >}}