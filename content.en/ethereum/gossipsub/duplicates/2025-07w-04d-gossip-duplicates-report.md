...
{{< plotly json="/plots/2025/02/13/ethereum_mainnet_ef-msg-duplicates-per-topic.json" height="600px" >}}
...
{{< plotly json="/plots/2025/02/13/ethereum_mainnet_ef-cdf-duplicates-per-msg-topic.json" height="600px" >}}

## Size of messages per topic

The following chart shows the CDF distribution of the message size seen by our tooling. 

{{< plotly json="/plots/2025/02/13/ethereum_mainnet_ef-cdf-size-per-msg-topic.json" height="600px" >}}
...
{{< plotly json="/plots/2025/02/13/ethereum_mainnet_ef-cdf-time-to-first-duplicate-per-msg-topic.json" height="600px" >}}
...
{{< plotly json="/plots/2025/02/13/ethereum_mainnet_ef-correlation-size-duplicates-topic.json" height="600px" >}}