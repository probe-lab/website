---
title: Week 2025-07 day 01
plotly: true
slug: 2025-07-01
weight: 929
---

# Ethereum report for message duplicates 2025-07 day 01

The following results show measurement data that were collected in **calendar week** 07  day 01 **of** 
2025 (`2025-02-17`).
...
{{< plotly json="/plots/2025/02/07/01/ethereum_mainnet_ef-msg-duplicates-per-topic.json" height="600px" >}}
...
{{< plotly json="/plots/2025/02/07/01/ethereum_mainnet_ef-cdf-duplicates-per-msg-topic.json" height="600px" >}}

## Size of messages per topic

The following chart shows the CDF distribution of the message size seen by our tooling. 

{{< plotly json="/plots/2025/02/07/01/ethereum_mainnet_ef-cdf-size-per-msg-topic.json" height="600px" >}}
...
{{< plotly json="/plots/2025/02/07/01/ethereum_mainnet_ef-cdf-time-to-first-duplicate-per-msg-topic.json" height="600px" >}}
...
{{< plotly json="/plots/2025/02/07/01/ethereum_mainnet_ef-correlation-size-duplicates-topic.json" height="600px" >}}