---
title: Week 2025-08 day 07
plotly: true
slug: 2025-08-07
weight: 1027729
---

# Ethereum report for message duplicates 2025-08 day 07

The following results show measurement data that were collected in **calendar week** 08  day 07 **of** 
2025 (`2025-02-23`).
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/23/ethereum_mainnet_ef-msg-duplicates-per-topic.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/23/ethereum_mainnet_ef-cdf-duplicates-per-msg-topic.json" height="600px" >}}

## Size of messages per topic

The following chart shows the CDF distribution of the message size seen by our tooling. 

{{< plotly json="https://cdn.probelab.io/legacy/2025/02/23/ethereum_mainnet_ef-cdf-size-per-msg-topic.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/23/ethereum_mainnet_ef-cdf-time-to-first-duplicate-per-msg-topic.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/02/23/ethereum_mainnet_ef-correlation-size-duplicates-topic.json" height="600px" >}}