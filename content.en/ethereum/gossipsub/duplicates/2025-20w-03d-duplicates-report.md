---
title: Week 2025-20 day 03
plotly: true
slug: 2025-20-03
weight: 1027649
---

# Ethereum report for message duplicates 2025-20 day 03

The following results show measurement data that were collected in **calendar week** 20  day 03 **of** 
2025 (`2025-05-14`).
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/ethereum_mainnet/2025/5/14/duplicates_per_topic_ts_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/ethereum_mainnet/2025/5/14/duplicates_cdf_per_msg_id_plot.json" height="600px" >}}

## Size of messages per topic

The following chart shows the CDF distribution of the message size seen by our tooling. 

{{< plotly json="https://cdn.probelab.io/duplicates_reports/ethereum_mainnet/2025/5/14/duplicates_cdf_of_msg_size_per_topic_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/ethereum_mainnet/2025/5/14/duplicates_cdf_of_time_to_first_duplicate_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/ethereum_mainnet/2025/5/14/duplicates_correlation_between_size_and_duplicates_plot.json" height="600px" >}}