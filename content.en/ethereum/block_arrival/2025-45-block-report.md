...
# Ethereum block broadcasting latency report 2025-45

The following results show measurement data that were collected in **calendar week** 45 **of** 2025 from `2025-11-03` to `2025-11-10`.
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/11/3/block_arrival_times_cdf_by_client_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/11/3/block_arrival_times_cdf_by_continent_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/11/3/block_arrival_correlation_with_size_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/11/3/block_arrival_time_series_percentiles_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/11/3/block_arrival_time_series_clients_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/11/3/block_arrival_time_series_continent_plot.json" height="600px" >}}
