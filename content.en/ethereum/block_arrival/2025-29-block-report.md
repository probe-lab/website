...
# Ethereum block broadcasting latency report 2025-29

The following results show measurement data that were collected in **calendar week** 29 **of** 2025 from `2025-07-14` to `2025-07-21`.
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/7/14/block_arrival_times_cdf_by_client_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/7/14/block_arrival_times_cdf_by_continent_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/7/14/block_arrival_correlation_with_size_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/7/14/block_arrival_time_series_percentiles_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/7/14/block_arrival_time_series_clients_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/7/14/block_arrival_time_series_continent_plot.json" height="600px" >}}
