...
# Ethereum block broadcasting latency report 2025-18

The following results show measurement data that were collected in **calendar week** 18 **of** 2025 from `2025-04-28` to `2025-05-05`.
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/4/28/block_arrival_times_cdf_by_client_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/4/28/block_arrival_times_cdf_by_continent_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/4/28/block_arrival_correlation_with_size_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/4/28/block_arrival_time_series_percentiles_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/4/28/block_arrival_time_series_clients_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/block_arrival_reports/ethereum_mainnet/2025/4/28/block_arrival_time_series_continent_plot.json" height="600px" >}}
