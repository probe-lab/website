...
# Ethereum discv5 weekly report 2024-20

The following results show measurement data that were collected in **calendar week** 20 **of** 2024 from `2024-05-13` to `2024-05-20`.
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-agents-versions.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-geo-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-geo-agents-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of beacon nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-geo-agent-All-lines.json" height="600px" >}}

This plot displays the weekly geographical distribution categorized by country, for each major user agent.

{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-geo-agents-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-cloud-rate-agents.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-cloud-agents-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-cloud-agents-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-stale-records-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-stale-records-mainnet-stacked.json" height="600px" >}}

## Protocols

This plot illustrates the evolving count of nodes supporting each of the listed protocols over time. It exclusively presents data gathered from nodes accessible through a libp2p connection via our crawler. The identification of supported protocols relies on the [libp2p identify protocol](https://github.com/libp2p/specs/tree/master/identify), hence necessitating a libp2p connection for discovery.

{{< plotly json="https://cdn.probelab.io/legacy/2024/05/13/discv5-crawl-protocols.json" height="1200px" >}}