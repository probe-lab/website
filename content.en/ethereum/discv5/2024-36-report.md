...
{{< plotly json="../../../plots/2024/09/02/discv5-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="../../../plots/2024/09/02/discv5-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-agents-versions.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-versions-distribution.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-protocols-support.json" height="1200px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-geo-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-geo-agents-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of beacon nodes, categorized by country.

{{< plotly json="../../../plots/2024/09/02/discv5-geo-agent-All-lines.json" height="600px" >}}

This plot displays the weekly geographical distribution categorized by country, for each major user agent.

{{< plotly json="../../../plots/2024/09/02/discv5-geo-agents-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-cloud-rate-agents.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-cloud-agents-bars.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-cloud-agents-lines.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-stale-records-stacked.json" height="600px" >}}
...
{{< plotly json="../../../plots/2024/09/02/discv5-stale-records-mainnet-stacked.json" height="600px" >}}