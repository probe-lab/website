...
# Ethereum discv5 weekly report 2024-30

The following results show measurement data that were collected in **calendar week** 30 **of** 2024 from `2024-07-22` to `2024-07-29`.
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-agents-overall.json" height="600px" >}}

This stacked plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-agents-versions.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-versions-distribution.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-protocols-support.json" height="1200px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-geo-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-geo-agents-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of beacon nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-geo-agent-All-lines.json" height="600px" >}}

This plot displays the weekly geographical distribution categorized by country, for each major user agent.

{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-geo-agents-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-cloud-rate-agents.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-cloud-agents-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-cloud-agents-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-stale-records-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/07/22/discv5-stale-records-mainnet-stacked.json" height="600px" >}}