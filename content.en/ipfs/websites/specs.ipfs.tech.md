...
{{< plotly json="../../../plots/latest/website-snapshot-performance-gauge-specs.ipfs.tech-IPFS-KUBO.json" height="300px" id="website-snapshot-performance-gauge-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-trend-metrics-specs.ipfs.tech-IPFS-KUBO.json" height="300px" id="website-trend-metrics-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-trend-providers-specs.ipfs.tech.json" height="350px" id="website-trend-providers" >}}
...
{{< plotly json="../../../plots/latest/website-trend-hosters-specs.ipfs.tech.json" height="250px" id="website-trend-hosters" >}}
...
{{< plotly json="../../../plots/latest/website-trend-retrieval-errors-specs.ipfs.tech-IPFS-KUBO.json" height="350px" id="website-trend-retrieval-errors-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-probes-count-specs.ipfs.tech-KUBO.json" height="150px" id="website-snapshot-probes-count-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-web-vitals-barchart-specs.ipfs.tech-IPFS-KUBO-eu-central-1.json" height="400px" id="website-snapshot-web-vitals-barchart-ipfs-kubo-eu-central-1" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-retrieval-errors-specs.ipfs.tech-KUBO.json" height="350px" id="website-snapshot-retrieval-errors-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-specs.ipfs.tech-IPFS-KUBO-ttfb.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-ttfb" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-ipfs-kubo-fcp}

{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-specs.ipfs.tech-IPFS-KUBO-fcp.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-fcp" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-ipfs-kubo-lcp}

{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-specs.ipfs.tech-IPFS-KUBO-lcp.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-lcp" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-kubo-ttfb}

{{< plotly json="../../../plots/latest/website-snapshot-http-ratio-specs.ipfs.tech-KUBO-ttfb.json" height="500px" id="ebsite-snapshot-http-ratio-kubo-ttfb" >}}
