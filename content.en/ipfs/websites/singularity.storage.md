---
title: singularity.storage
plotly: true
aliases:
    - /websites/singularity.storage
---

# `singularity.storage`

This page shows performance metrics for the website [singularity.storage](https://singularity.storage). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
{{< plotly json="../../../plots/latest/website-snapshot-performance-gauge-singularity.storage-IPFS-KUBO.json" height="300px" id="website-snapshot-performance-gauge-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-trend-metrics-singularity.storage-IPFS-KUBO.json" height="300px" id="website-trend-metrics-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-trend-providers-singularity.storage.json" height="350px" id="website-trend-providers" >}}
...
{{< plotly json="../../../plots/latest/website-trend-hosters-singularity.storage.json" height="250px" id="website-trend-hosters" >}}
...
{{< plotly json="../../../plots/latest/website-trend-retrieval-errors-singularity.storage-IPFS-KUBO.json" height="350px" id="website-trend-retrieval-errors-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-probes-count-singularity.storage-KUBO.json" height="150px" id="website-snapshot-probes-count-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-web-vitals-barchart-singularity.storage-IPFS-KUBO-eu-central-1.json" height="400px" id="website-snapshot-web-vitals-barchart-ipfs-kubo-eu-central-1" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-retrieval-errors-singularity.storage-KUBO.json" height="350px" id="website-snapshot-retrieval-errors-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-singularity.storage-IPFS-KUBO-ttfb.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-ttfb" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-ipfs-kubo-fcp}

{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-singularity.storage-IPFS-KUBO-fcp.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-fcp" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-ipfs-kubo-lcp}

{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-singularity.storage-IPFS-KUBO-lcp.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-lcp" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-kubo-ttfb}

{{< plotly json="../../../plots/latest/website-snapshot-http-ratio-singularity.storage-KUBO-ttfb.json" height="500px" id="ebsite-snapshot-http-ratio-kubo-ttfb" >}}
