...
plotly: true
aliases:
    - /websites/n0.computer
---

# `n0.computer`

This page shows performance metrics for the website [n0.computer](https://n0.computer). We gathered the data with our [Tiros](/tools/tiros) measurement tool.
...
{{< plotly json="../../../plots/latest/website-snapshot-performance-gauge-n0.computer-IPFS-KUBO.json" height="300px" id="website-snapshot-performance-gauge-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-trend-metrics-n0.computer-IPFS-KUBO.json" height="300px" id="website-trend-metrics-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-trend-providers-n0.computer.json" height="350px" id="website-trend-providers" >}}
...
{{< plotly json="../../../plots/latest/website-trend-hosters-n0.computer.json" height="250px" id="website-trend-hosters" >}}
...
{{< plotly json="../../../plots/latest/website-trend-retrieval-errors-n0.computer-IPFS-KUBO.json" height="350px" id="website-trend-retrieval-errors-ipfs-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-probes-count-n0.computer-KUBO.json" height="150px" id="website-snapshot-probes-count-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-web-vitals-barchart-n0.computer-IPFS-KUBO-eu-central-1.json" height="400px" id="website-snapshot-web-vitals-barchart-ipfs-kubo-eu-central-1" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-retrieval-errors-n0.computer-KUBO.json" height="350px" id="website-snapshot-retrieval-errors-kubo" >}}
...
{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-n0.computer-IPFS-KUBO-ttfb.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-ttfb" >}}

#### First Contentful Paint {#website-snapshot-metric-cdf-ipfs-kubo-fcp}

{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-n0.computer-IPFS-KUBO-fcp.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-fcp" >}}

#### Largest Contentful Paint {#website-snapshot-metric-cdf-ipfs-kubo-lcp}

{{< plotly json="../../../plots/latest/website-snapshot-metric-cdf-n0.computer-IPFS-KUBO-lcp.json" height="320px" id="website-snapshot-metric-cdf-ipfs-kubo-lcp" >}}

### Kubo vs HTTP Latency Comparison (TTFB) {#website-snapshot-http-ratio-kubo-ttfb}

{{< plotly json="../../../plots/latest/website-snapshot-http-ratio-n0.computer-KUBO-ttfb.json" height="500px" id="ebsite-snapshot-http-ratio-kubo-ttfb" >}}
