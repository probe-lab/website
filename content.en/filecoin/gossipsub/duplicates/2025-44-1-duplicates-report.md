---
title: Week 2025-44 day 01
plotly: true
slug: 2025-44-01
weight: 1027483
---

# Filecoin report for message duplicates 2025-44 day 01

The following results show measurement data that were collected in **calendar week** 44  day 01 **of** 
2025 (`2025-10-27`).
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/10/27/duplicates_per_topic_ts_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/10/27/duplicates_cdf_per_msg_id_plot.json" height="600px" >}}

## Size of messages per topic

The following chart shows the CDF distribution of the message size seen by our tooling. 

{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/10/27/duplicates_cdf_of_msg_size_per_topic_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/10/27/duplicates_cdf_of_time_to_first_duplicate_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/duplicates_reports/filecoin_mainnet/2025/10/27/duplicates_correlation_between_size_and_duplicates_plot.json" height="600px" >}}