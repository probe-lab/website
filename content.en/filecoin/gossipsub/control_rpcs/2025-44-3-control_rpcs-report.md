...
# Filecoin report for GossipSub's Control Messages 2025-44 day 03
...
{{< plotly json="https://cdn.probelab.io/control_rpcs_reports/filecoin_mainnet/2025/10/29/control_rpc_ratio_ts_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/control_rpcs_reports/filecoin_mainnet/2025/10/29/control_rpc_effectiveness_msg_id_ts_plot.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/control_rpcs_reports/filecoin_mainnet/2025/10/29/control_rpc_effectiveness_msg_id_per_topic_ts_plot.json" height="600px" >}}