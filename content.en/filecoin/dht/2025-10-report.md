...
# Filecoin Report Cal. Week 10 - 2025

## General Information

The following results show measurement data that were collected in calendar week 10 in 2025 from `2025-03-03` to `2025-03-10`.

- Number of crawls `84`
- Number of visits `436,861`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `832`
- Number of unique peer IDs discovered in the DHT `832`
- Number of unique IP addresses found `608`
...
{{< plotly json="/plots/2025/03/03/filecoin-agents-overall.json" height="600px" >}}

This plot shows the distribution of various user agents over time.

{{< plotly json="/plots/2025/03/03/filecoin-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2025/03/03/filecoin-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-crawl-protocols.json" height="1200px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-connection-errors-percentage.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-crawl-errors-percentage.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-stale-records-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-regions-population.json" height="600px" >}}
...
{{< plotly json="/plots/2025/03/03/filecoin-density-distributions.json" height="600px" >}}