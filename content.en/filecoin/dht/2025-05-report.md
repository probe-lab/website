...
# Filecoin Report Cal. Week 5 - 2025
...
- Number of crawls `84`
- Number of visits `505,489`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `876`
- Number of unique peer IDs discovered in the DHT `876`
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-agents-overall.json" height="600px" >}}

This plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-crawl-protocols.json" height="1200px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-connection-errors-percentage.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-crawl-errors-percentage.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-stale-records-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-regions-population.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2025/01/27/filecoin-density-distributions.json" height="600px" >}}