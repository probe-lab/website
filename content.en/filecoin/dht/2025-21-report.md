...
- Number of crawls `84`
- Number of visits `378,425`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `644`
- Number of unique peer IDs discovered in the DHT `644`
- Number of unique IP addresses found `499`
...
{{< plotly json="/plots/2025/05/19/filecoin-agents-overall.json" height="600px" >}}

This plot shows the distribution of various user agents over time.

{{< plotly json="/plots/2025/05/19/filecoin-agents-overall-stacked.json" height="600px" >}}

This plot shows the distribution of agent versions by quality adjust power (QAP) and raw bytes power (RBP).

{{< plotly json="https://cdn.probelab.io/plots/filecoin_mainnet/2025/05/19/powers_by_agent_plot.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/2025/05/19/filecoin-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-crawl-protocols.json" height="1200px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-connection-errors-percentage.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-crawl-errors-percentage.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-stale-records-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-regions-population.json" height="600px" >}}
...
{{< plotly json="/plots/2025/05/19/filecoin-density-distributions.json" height="600px" >}}