...
{{< plotly json="/plots/filecoin-agents-overall.json" height="600px" >}}

This plot shows the distribution of various user agents over time.

{{< plotly json="/plots/filecoin-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="/plots/filecoin-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="/plots/filecoin-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-crawl-protocols.json" height="1200px" >}}
...
{{< plotly json="/plots/filecoin-connection-errors-percentage.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-crawl-errors-percentage.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-stale-records-stacked.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-regions-population.json" height="600px" >}}
...
{{< plotly json="/plots/filecoin-density-distributions.json" height="600px" >}}