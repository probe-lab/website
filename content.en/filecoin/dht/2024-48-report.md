...
# Filecoin Report Cal. Week 48 - 2024
...
- Number of visits `786,005`
  > Visiting a peer means dialing or connecting to it. Every time the crawler or monitoring process tries to dial or connect to a peer we consider this as _visiting_ it. Regardless of errors that may occur.
- Number of unique peer IDs visited `986`
- Number of unique peer IDs discovered in the DHT `986`
- Number of unique IP addresses found `715`
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-agents-overall.json" height="600px" >}}

This plot shows the distribution of various user agents over time.

{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-agents-overall-stacked.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-network-stability-cdf.json" height="800px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-geo-agent-All-bars.json" height="600px" >}}

This plot displays the weekly geographical distribution of nodes, categorized by country.

{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-geo-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-cloud-rate-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-cloud-agent-All-bars.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-cloud-agent-All-lines.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-crawl-protocols.json" height="1200px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-connection-errors-percentage.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-crawl-errors-percentage.json" height="600px" >}}
...
{{< plotly json="https://cdn.probelab.io/legacy/2024/11/25/filecoin-stale-records-stacked.json" height="600px" >}}